...
//
const BotName = 'MONSTER 🤖'; // Nama Bot Whatsapp
...
conn.sendMessage(id, '3aalaikumsalam, can I help you? if confused type #help ya say..' ,MessageType.text);
}
else if (text == 'salam'){
...
conn.sendMessage(id, 'Yes How can I help you? if confused type #help ya say..' ,MessageType.text);
}
else if (text == 'hai'){
...
conn.sendMessage(id, 'Same same, have a nice day :)' ,MessageType.text);
}
else if (text == 'Thank'){
conn.sendMessage(id, 'Same same, have a nice day :)' ,MessageType.text);
}
